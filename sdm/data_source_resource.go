...
func dataSourceResourceList(ctx context.Context, d *schema.ResourceData, cc *sdm.Client) error {
	...
	for resp.Next() {
		...
		case *sdm.AmazonESIAM:
			output[0]["amazon_esiam"] = append(output[0]["amazon_esiam"], entity{
				"bind_interface":   (v.BindInterface),
				"egress_filter":    (v.EgressFilter),
				"endpoint":         (v.Endpoint),
				"id":               (v.ID),
		...
		case *sdm.AMQP:
			output[0]["amazonmq_amqp"] = append(output[0]["amazonmq_amqp"], entity{
				"bind_interface":   (v.BindInterface),
				"egress_filter":    (v.EgressFilter),
				"hostname":         (v.Hostname),
				"id":               (v.ID),
		...
		case *sdm.AthenaIAM:
			output[0]["athena_iam"] = append(output[0]["athena_iam"], entity{
				"bind_interface":   (v.BindInterface),
				"egress_filter":    (v.EgressFilter),
				"id":               (v.ID),
				"name":             (v.Name),
		...
		case *sdm.AuroraMysqlIAM:
			output[0]["aurora_mysql_iam"] = append(output[0]["aurora_mysql_iam"], entity{
				"bind_interface":      (v.BindInterface),
				"database":            (v.Database),
				"egress_filter":       (v.EgressFilter),
				"hostname":            (v.Hostname),
		...
		case *sdm.AWSInstanceProfile:
			output[0]["aws_instance_profile"] = append(output[0]["aws_instance_profile"], entity{
				"bind_interface":       (v.BindInterface),
				"egress_filter":        (v.EgressFilter),
				"enable_env_variables": (v.EnableEnvVariables),
				"id":                   (v.ID),
		...
		case *sdm.AzureMysqlManagedIdentity:
			output[0]["azure_mysql_managed_identity"] = append(output[0]["azure_mysql_managed_identity"], entity{
				"bind_interface":                    (v.BindInterface),
				"database":                          (v.Database),
				"egress_filter":                     (v.EgressFilter),
				"hostname":                          (v.Hostname),
		...
		case *sdm.Databricks:
			output[0]["databricks"] = append(output[0]["databricks"], entity{
		...
		case *sdm.ElasticacheRedisIAM:
			output[0]["elasticache_redis_iam"] = append(output[0]["elasticache_redis_iam"], entity{
				"bind_interface":      (v.BindInterface),
				"egress_filter":       (v.EgressFilter),
				"hostname":            (v.Hostname),
				"id":                  (v.ID),
		...
		case *sdm.MCPDCR:
			output[0]["mcpdcr"] = append(output[0]["mcpdcr"], entity{
				"bind_interface":          (v.BindInterface),
				"egress_filter":           (v.EgressFilter),
				"hostname":                (v.Hostname),
				"id":                      (v.ID),
		...
		case *sdm.RedshiftIAM:
			output[0]["redshift_iam"] = append(output[0]["redshift_iam"], entity{
				"bind_interface":      (v.BindInterface),
		...
		case *sdm.RedshiftServerlessIAM:
			output[0]["redshift_serverless_iam"] = append(output[0]["redshift_serverless_iam"], entity{
				"bind_interface":      (v.BindInterface),
				"database":            (v.Database),
				"egress_filter":       (v.EgressFilter),
				"hostname":            (v.Hostname),
		...
		case *sdm.Vertica:
			output[0]["vertica"] = append(output[0]["vertica"], entity{
				"bind_interface":   (v.BindInterface),
				"database":         (v.Database),
				"egress_filter":    (v.EgressFilter),
				"hostname":         (v.Hostname),
